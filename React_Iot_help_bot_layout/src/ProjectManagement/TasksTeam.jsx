...
export default function TasksTeam() {
  const [tasksTeam, setTasksTeam] = useState({
    team: [
      { name: "Alice", role: "Hardware Engineer", responsibility: "Sensor integration", icon: "🔌" },
      { name: "Bob", role: "Backend Dev", responsibility: "API & DB", icon: "💾" },
      { name: "Charlie", role: "Frontend Dev", responsibility: "UI/UX Dashboard", icon: "🖥️" }
    ],
    status: "In Progress"
  });
  const [tasks, setTasks] = useState([
    { title: "Connect Temperature Sensor", owner: "Hardware Student", status: "Done" },
    { title: "Setup Database Schema", owner: "Backend Student", status: "In Progress" },
    { title: "Design Dashboard Layout", owner: "Frontend Student", status: "Done" }
  ]);
